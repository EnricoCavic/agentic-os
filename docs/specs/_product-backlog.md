...
|---|---|---|---|---|---|---|---|---|
| 1 | Tiered Document Lifecycle Engine (4-tier state machine + config) | — | — | — | docs/specs/tiered-doc-lifecycle.md | feature | Pending | — |
| 2 | Global Lessons cap + archive rotation | — | — | — | — | quick-win | Shipped | — |
| 3 | Archive directory GC + INDEX.jsonl rotation | — | — | — | — | feature | Pending | #1 |
...
| 7 | Domain Doc L2 superseded entry archival | — | — | — | — | quick-win | Pending | — |
| 8 | `_product-backlog.md` completed backlog archive | — | — | — | — | quick-win | Pending | — |
...
| 11 | Shipped specs accumulation — status-driven filtering | — | — | — | — | quick-win | Pending | #1 |
| 12 | validate.{sh,ps1}: archive size WARN check (Global Lessons cap already PASS) | — | — | — | — | quick-win | Shipped | — |
| 13 | Warm→Cold LLM summarization pass in /ship | — | — | — | — | feature | Pending | #1, #3 |
| 14 | External Skill Research & Integration (Phase A: 3 core skills) | — | — | — | docs/specs/skill-research-integration.md | feature | Pending | — |
| 15 | Anti-Rationalization Pattern (framework-wide enhancement) | — | — | — | docs/specs/skill-research-integration.md §4C | quick-win | Pending | #14 |
| 16 | Skill Validation Pipeline (meta-governance) | — | — | — | docs/specs/skill-research-integration.md §4D | feature | Pending | #14 |
| 17 | Hard Work Log lock (advisory → blocking) | — | — | — | — | feature | Pending | — |
| 18 | Lightweight routing heuristics (decision tree in config.yaml, not a DSL) | — | — | — | — | quick-win | Pending | — |
| 19 | SSoT atomic writes (guard_context_write: CAS or transactional store) | — | — | — | — | feature | Pending | — |
| 20 | CI security scanning (Semgrep + TruffleHog + dependency audit) | — | — | — | — | feature | Pending | — |
| 21 | Skill cache timestamp + staleness invalidation | — | — | — | — | quick-win | Pending | — |
...
| 33 | Claude Code plugin packaging (.claude-plugin/plugin.json + bin/ + commands/agents/hooks bundling, no monitors) | — | — | — | — | feature | Pending | #30, #31 |
...
| 38 | AGENTS.md token-budget pass (~150 → ≤100 lines, link out detail to guides) | — | — | — | — | quick-win | Pending | — |
