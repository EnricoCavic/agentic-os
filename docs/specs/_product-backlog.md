...
| 50 | Spec drift linter (AC coverage vs git diff, advisory) | framework | governance | P2 | docs/specs/spec-drift-linter.md | feature | In Progress | [#156](https://github.com/KbWen/agentic-os/issues/156) | — |
