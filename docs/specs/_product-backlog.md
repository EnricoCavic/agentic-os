...
| 17 | Hard Work Log lock (advisory → blocking) | framework | concurrency | P1 | docs/specs/worklog-lock-blocking.md | feature | In Progress | [#147](https://github.com/KbWen/agentic-os/issues/147) | — |
